![image](https://github.com/user-attachments/assets/53e3c6b6-7383-4998-aef3-4765d78d4621)
...
2. 퀴즈는 매주 월요일 자정(오전 12시)까지 제출한다.
3. 정기 모임 때 사다리 타기를 통해 발표할 퀴즈를 선택하여 해당 퀴즈 답변에 대해 발표한다.
4. 발표한 퀴즈 답변에 대하여 자유롭게 질문한다.

   
# 3️⃣ 진행 일정
1. 매주 2개의 챕터를 진행한다.
2. 매주 월요일 자정까지 퀴즈를 제출한다.
3. 매주 목요일 오후 9시에 모여서 각자 퀴즈를 발표한다.(25년 1월까지는 목요일 오후 4시에 모임)
